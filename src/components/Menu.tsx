  ...
  return (
    <>
      ...
      <div className="text-center mb-12">
        <h2 className="text-5xl font-sans font-bold text-brand-text-primary mb-4">Our Menu</h2>
        <p className="text-brand-text-secondary max-w-2xl mx-auto text-lg">
        Specialty Shop For Pilipino Pamealies
        </p>
      </div>
        ...
        return (
          <section key={category.id} id={category.id} className="mb-16">
            <div className="flex items-center mb-8 pb-4 border-b-2 border-brand-primary">
              ...
              <h3 className="text-4xl font-sans font-bold text-brand-text-primary">{category.name}</h3>
            </div>
